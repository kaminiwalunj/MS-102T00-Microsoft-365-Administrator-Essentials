...
26. Scroll down through the navigation pane, and under **Admin centers,** select **Exchange**. This will open the Exchange admin center in a new tab. 
...
27. In the **Exchange admin center**, in the left navigation pane, select **Mail flow**, and then select **Message trace**. 
...
35. Repeat this step for the second failed message. 
